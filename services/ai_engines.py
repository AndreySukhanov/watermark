...
AI_ENGINES: dict[str, AIEngineConfig] = {
    "lama_fast": AIEngineConfig(
        ...
        label="LaMa Fast",
        family="lama",
        description="Fastest mode, tuned for long clips.",
    ...
    "propainter_quality": AIEngineConfig(
        ...
        label="ProPainter",
        family="propainter",
        description="Video-aware quality mode with better temporal consistency.",
...
_STR_OVERRIDE_KEYS = {
    ...
    "mask_shape": {"auto", "hf_segmenter", "hybrid_segmenter", "temporal_hf_segmenter", "ocr"},
