...
SOURCE_VIDEO = Path(os.environ.get("SOURCE_VIDEO", str(ROOT / "temp_web" / "sample_source.mp4")))
REGIONS_FILE = Path(os.environ.get("REGIONS_FILE", str(ROOT / "assets" / "watermark_regions.json")))
