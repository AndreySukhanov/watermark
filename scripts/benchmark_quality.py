...
VIDEO_FILE = Path(os.environ.get("VIDEO_FILE", r"./\SAMPLE.mp4"))
...
REGIONS_PATH = Path(os.environ.get("REGIONS_FILE", str(Path(__file__).resolve().parents[1] / "assets" / "watermark_regions.json")))
